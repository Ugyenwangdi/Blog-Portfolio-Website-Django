    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='author', to='wulfi.profile')),
                ('tags', models.ManyToManyField(blank=True, to='wulfi.Tag')),
            ],
            options={
                'ordering': ('-publish',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='comments', to='wulfi.post')),
            ],
        ),
    ]
